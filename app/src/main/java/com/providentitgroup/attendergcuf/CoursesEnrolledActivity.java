...
public class CoursesEnrolledActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courses_enrolled);
        context =this;

        progressBar = findViewById(R.id.progressBar);
        recyclerView = findViewById(R.id.enrolled_courses_recycler_view);
        ...
        requestData(DataRequester.BASE_STUDENT_MODULE_URL+"subjectEnrollment.php");
    ...
    public void requestData( String url) {
        DataRequester.get(context, url, null, new TextHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                showGeneralError();
                if(statusCode==404){
                    startActivity(new Intent(CoursesEnrolledActivity.this,LoginActivity.class));
                    finishAffinity();
                }
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                if(statusCode==200){
                    ...
                    for(int i=1; i<rows.size();i++){
                        try {
                            coursesList.add(new EnrolledCourseItem(rows.get(i).children()));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
